...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'pointer-events-none block size-5 rounded-full shadow-lg ring-0 transition-[transform,background-color] duration-200',
        'data-[state=checked]:translate-x-5 data-[state=checked]:bg-bg-base data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-text',
      )}
    />
  </SwitchPrimitive.Root>
));
